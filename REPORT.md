...
1. [Описание тестируемого приложения](#1-описание-тестируемого-приложения)
   - [1.1 Архитектура](#11-архитектура)
   - [1.2 Используемые технологии](#12-используемые-технологии)
   - [1.3 База данных](#13-база-данных)
   - [1.4 Эндпоинты/Методы](#14-эндпоинтыметоды)
   - [1.5 Данные для запросов](#15-данные-для-запросов)

2. [Настройки тестовой среды](#2-настройки-тестовой-среды)
   - [2.1 Аппаратные ресурсы](#21-аппаратные-ресурсы)
   - [2.2 Архитектура стенда](#22-архитектура-стенда)
   - [2.3 Версия Locust](#23-версия-locust)

3. [Тестовые сценарии](#3-тестовые-сценарии)
   - [3.1 Сценарий 1: Sanity Check (Легкая нагрузка)](#31-сценарий-1-sanity-check-легкая-нагрузка)
   - [3.2 Сценарий 2: Normal Load (Рабочая нагрузка)](#32-сценарий-2-normal-load-рабочая-нагрузка)
   - [3.3 Сценарий 3: Stress Test (Стресс-тест)](#33-сценарий-3-stress-test-стресс-тест)
   - [3.4 Сценарий 4: Stability Test (Тест на стабильность)](#34-сценарий-4-stability-test-тест-на-стабильность)

4. [Результаты тестирования](#4-результаты-тестирования)
   - [4.1 Сценарий 1: Sanity Check](#41-сценарий-1-sanity-check)
   - [4.2 Сценарий 2: Normal Load](#42-сценарий-2-normal-load)
   - [4.3 Сценарий 3: Stress Test](#43-сценарий-3-stress-test)
   - [4.4 Сценарий 4: Stability Test](#44-сценарий-4-stability-test)

5. [Анализ результатов](#5-анализ-результатов)
   - [5.1 Деградация производительности](#51-деградация-производительности)
   - [5.2 Изменение латентности при росте нагрузки](#52-изменение-латентности-при-росте-нагрузки)
   - [5.3 Бутылочное горлышко](#53-бутылочное-горлышко)

6. [Сравнение REST и gRPC](#6-сравнение-rest-и-grpc)
   - [6.1 Численное сравнение латентности](#61-численное-сравнение-латентности)
   - [6.2 Сравнение RPS](#62-сравнение-rps)
   - [6.3 Анализ overhead](#63-анализ-overhead)

7. [Заключение](#7-заключение)
   - [7.1 Основные выводы](#71-основные-выводы)
   - [7.2 Рекомендации по оптимизации](#72-рекомендации-по-оптимизации)
   - [7.3 Возможные улучшения эксперимента](#73-возможные-улучшения-эксперимента)
   - [7.4 Ограничения проведённого тестирования](#74-ограничения-проведённого-тестирования)

[Приложения](#приложения)
   - [A. Графики и визуализации](#a-графики-и-визуализации)
   - [B. Сырые данные](#b-сырые-данные)
   - [C. Конфигурация тестов](#c-конфигурация-тестов)
